...
public class ClienteCreditos {
    public static void main(String[] args) {
        ...
        Credito credito3 = new Credito(3, new CreditoTipo("Prestamo", 100.0, 200.0, 1, 3, ClienteTipoEnum.COMERCIO, 10.5), new Cliente("Ginobili", "Emanuel", 123124213, ClienteTipoEnum.COMERCIO), 1000.0, 5, new Sucursal("Sucursal 2"),devolver.getTotalDevolver());
        Credito credito4 = new Credito(4, new CreditoTipo("Prestamo", 2000.00, 10000.50, 1, 3, ClienteTipoEnum.EMPRESADECONSTRUCCION, 15.0),new Cliente("Alcaraz", "Juan", 23617421, ClienteTipoEnum.EMPRESADECONSTRUCCION), 10000000.00, 5,new Sucursal("Sucursal 3"),devolver.getTotalDevolver());
        Credito credito2 = new Credito(2, new CreditoTipo("Prestamo", 2000.00, 10000.50, 1, 3, ClienteTipoEnum.PERSONA, 2.50),new Cliente("Federer", "Roger", 12364521, ClienteTipoEnum.PERSONA), 20500.00, 5,new Sucursal("Sucursal 1"),devolver.getTotalDevolver());
        Credito credito5 = new Credito(5, new CreditoTipo("Prestamo", 2000.00, 10000.50, 1, 3, ClienteTipoEnum.PERSONA, 2.50),new Cliente("Del Potro", "Juan Martin", 24357537, ClienteTipoEnum.PERSONA), 18500.00, 5,new Sucursal("Sucursal 5"),devolver.getTotalDevolver());
        Credito credito6 = new Credito(6, new CreditoTipo("Prestamo", 2000.00, 10000.50, 1, 3, ClienteTipoEnum.COMERCIO, 2.50),new Cliente("Pedro", "Juan", 24357537, ClienteTipoEnum.COMERCIO), 18500.00, 5,new Sucursal("Sucursal 2"),devolver.getTotalDevolver());
